...
class GzipCompression<K, S, V, I extends InputFormat<K, V>, O extends OutputFormat<S, V>>
    extends AbstractCompression<K, S, V, I, O> {

    public static final Logger logger = Logger.getLogger(GzipCompression.class);

    private long inputBlockSize;

    public GzipCompression(JavaSparkContext sparkContext, FileSystem fileSystem,
    ...
    protected void setupJobConf(JobConf jobConf) {
        ...
        jobConf.set(COMPRESSION_CODEC_KEY, GzipCodec.class.getName());
